<x-app-layout>
    ...
    <x-breadcrumb :items="[['text' => 'Dashboard', 'link' => $dashboard], ['text' => 'Riwayat Belajar Member', 'link' => null]]" />
    <x-card>
        <!-- Start coding here -->
                ...
                <table class="w-full text-xs 2xl:text-tiny text-left text-gray-500">
                    <thead class="text-xs 2xl:text-tiny text-gray-700 uppercase bg-gray-50 ">
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3">Jumlah Member</th>
                            ...
                            <tr class="{{ $loop->last ? '' : 'border-b border-gray-200' }}">
                                ...
                                <td scope="row" class="px-4 py-3">
                                    <div class="flex items-center justify-end space-x-2">
                                        <x-button text="Detail"
                                            onclick="window.location.href='{{ route('facilitator.history-member.detail', $data->id) }}'" />
                                    </div>
                                </td>
                            </tr>
                        @endforeach
