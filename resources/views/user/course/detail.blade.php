<x-guest-layout>
    <div class="max-w-7xl mx-auto px-4 xl:px-0 py-12 gap-8">
                        ...
                        <div data-accordion="open" class="mt-{{ $i > 1 ? 3 : 8 }} mx-4 md:mx-0">
                            <h2 class="rounded-lg mb-3 bg-white">
                                <button type="button"
                                    ...
                                    aria-expanded="false" aria-controls="accordion-arrow-icon-body-{{ $i }}">
                            ...
                            <div id="accordion-arrow-icon-body-{{ $i }}" class="hidden mb-4"
                                ...
                                <div class="p-5 bg-white rounded-lg">
                                    <p class="text-black text-xs 2xl:text-sm">
                                        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Asperiores nemo sed
                                        eligendi veniam autem accusamus eos mollitia possimus obcaecati quia? Unde ad
        ...
        <div id="detail-course"
            class="w-full justify-center mx-auto max-w-md h-fit bg-white border border-gray-200 rounded-lg shadow p-6">
            ...
            <ul role="list" class="space-y-5">
                ...
                <li class="flex space-x-3 decoration-black">
                    ...
                    <span class="text-sm md:text-sm  xl:text-sm font-normal leading-tight text-black">Akses di Perangkat
                        Apapun</span>
                </li>
                <li class="flex space-x-3 decoration-black">
                    <ion-icon name="layers-outline" class="text-[#2B3176]"></ion-icon>
                    <span class="text-sm md:text-sm  xl:text-sm font-normal leading-tight text-black">Soal latihan dan
                        kuis</span>
                </li>
                <li class="flex space-x-3 decoration-black">
