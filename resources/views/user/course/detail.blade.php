        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 lg:gap-x-6 mt-8 md:mt-12">
            ...
            <div class="rounded-lg w-full col-span-2">
                ...
                <div>
                    ...
                    <section>
                        @for ($i = 1; $i <= 3; $i++)
                            <div data-accordion="open" class="mt-{{ $i > 1 ? 3 : 8 }} md:mx-0">
                                <h2 class="rounded-lg mb-3 bg-white">
                                    <button type="button"
                                        ...
                                        <div class="flex items-center space-x-2">
                                            <span class="font-semibold text-xs 2xl:text-sm">
                                                {{ $i }}.
                                            </span>
                                            <span class="text-xs 2xl:text-sm">Dasar-dasar Project Network
                                                Planning</span>
                                        </div>
            ...
            {{-- Detail Course --}}
            <div id="detail-course" class="min-w-min h-fit bg-white border border-gray-200 rounded-xl p-6">
                ...
                <ul role="list" class="space-y-5">
                    ...
                    <li class="flex space-x-3 decoration-black">
                        ...
                        <span class="text-sm md:text-sm  xl:text-sm font-normal leading-tight text-black">Soal
                            latihan dan
                            kuis</span>
                    </li>
                    <li class="flex space-x-3 decoration-black">
