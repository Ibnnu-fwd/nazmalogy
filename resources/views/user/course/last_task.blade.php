    ...
    <div class="max-w-3xl mx-auto">
        <x-card>
            ...
            <ol
                ...
                <li
                    class="flex md:w-full items-center {{ $submission->status == 'pending' ? 'text-primary font-semibold ' : '' }}  after:content-[''] after:w-full after:h-1 after:border-b after:border-gray-200 after:border-1 after:hidden sm:after:inline-block after:mx-6 xl:after:mx-10 ">
                    <span class="flex items-center after:content-['/'] sm:after:hidden after:mx-2 after:text-gray-200">
                        Pengumpulan
                    </span>
                </li>
